...
public class EpassJovem extends EpassStandard implements TituloTransporte {
    ...
    public EpassJovem(DocumentoID documentoID, TipoDocumento tipoDocumento, LocalDate ddn, String nome, String email, double saldo, Titular titular, int pontos, int numeroViagem, String ChaveValida) {
        super(documentoID, tipoDocumento, ddn, nome, email, saldo, titular, pontos, numeroViagem, ChaveValida);
    }

    public EpassJovem(Titular titular, int pontos, int numeroViagem, String chaveValida) {
